// This applications holds basic notes for Part II
...
public class ApplicationPart2 {

	// Note 2.3 
	// This the code for a logger
	private  static final Logger log = LoggerFactory.getLogger(ApplicationPart2.class);
	...
	public static void main(String[] args) {
		...
		SpringApplication.run(ApplicationPart2.class, args);
